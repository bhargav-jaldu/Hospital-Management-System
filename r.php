...
<head>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top">
        <a class="navbar-brand" href="#"><i class="fa fa-user-plus" aria-hidden="true"></i> EasyMed </a>
            ...
            <div class="col-md-8" style="margin-top: 3%;">
              ...
              document.getElementById('spec').onchange = function updateSpecs(e) {
                ...
                document.getElementById('doctor1').value = document.querySelector(`[value=${values}]`).getAttribute('data-value');
                    ...
                    $query = "select ID,doctor,docFees,appdate,apptime,userStatus,doctorStatus from appointmenttb where fname ='Yasas' and lname='Inukollu';";
                  ...
                  ?>
                    ...
                    $query = "select doctor,ID,fname,lname,appdate,apptime,disease,allergy,prescription from prestb ;";
                  ...
                  ?>
                                <tr>
                                    ...
                                    <td><button class="btn btn-primary" onclick="bill()">Pay Bill</button></td>
                                    <td>
                                        <form method="get">
                    ...
                    <script>
                    function bill() {
                        document.location.href = "http://localhost/EasyMed@VITAP/paybill.php";
                    }
                    </script>
